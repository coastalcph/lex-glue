...
def main():
    ...
    if training_args.do_train:
        train_dataset = load_dataset("lex_glue", "eurlex", split="train", data_dir='data', cache_dir=model_args.cache_dir)

    if training_args.do_eval:
        eval_dataset = load_dataset("lex_glue", "eurlex", split="validation", data_dir='data', cache_dir=model_args.cache_dir)

    if training_args.do_predict:
        predict_dataset = load_dataset("lex_glue", "eurlex", split="test", data_dir='data', cache_dir=model_args.cache_dir)
